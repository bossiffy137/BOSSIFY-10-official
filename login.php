...
<body>
    ...
    <form class="login-form" action="process_login.php" method="POST">
        ...
        <a href="forgot_password.php" style="color: #ff69b4; text-decoration: none; margin-top: 12px; display: inline-block;">Forgot Password?</a> <!-- Forgot Password link -->
        <div style="margin: 12px 0; font-weight: bold; color: #fff;">OR</div> <!-- Added OR -->
        <a href="CA.php" style="color: #ff69b4; text-decoration: none; display: inline-block;">Create Account</a> <!-- Updated Create Account link -->
    </form>
    <script>
